...
from fionaa.policy_consistency import policy_digest
from fionaa.policy_loader import load_policy_text
from fionaa.domain.applications import LoanType

ROOT = Path(__file__).resolve().parents[2] / "agentcore" / "automated-reasoning"
...
def test_iam_allows_required_us_guardrail_profile_destinations():
    ...
    for region in ("us-east-1", "us-east-2", "us-west-2"):
        assert (f"arn:aws:bedrock:{region}:123456789012:"
